...
public class Login_Panel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(".gif"));
        add(jLabel2);
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        if(txt_user_name.getText().trim().isEmpty() || txt_pass.getText().trim().isEmpty()){
            ...
            try{
                ...
                Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/App_db", "root", "");
...
//                    App.login_frmae.setVisible(false);
                }else{
